              ...
              <thead>
                <tr>
                  ...
                  <th className='kks_text_center' style={{width:"14%"}}>
                    <span style={{marginRight: 15}}>Price</span>
                    <span style={arrow}>
                  ...
                  <th className='kks_text_center' style={{width:"14%"}}>
                    <span style={{marginRight: 15}}>24H High</span>
                    <span style={arrow}>
                  ...
                  <th className='kks_text_center' style={{width:"14%"}}>
                    <span style={{marginRight: 15}}>24H Low</span>
                    <span style={arrow}>
                  ...
                  <th className='kks_text_center' style={{width:"14%"}}>
                    <span style={{marginRight: 15}}>24H Volume</span>
                    <span style={arrow}>
